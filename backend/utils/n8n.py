...
class N8NClient:
    ...
    def trigger_upload(self, archivo_base64: str, filename: str, session_id: str) -> dict:
        ...
        print(f"📤 Disparando N8N webhook para {filename} (request_id={request_id})")
        try:
            ...
            raise Exception("N8N no responde")
        except Exception as e:
            print(f"⚠️ N8N no disponible: {e}")
            return {"status": "error", "detail": str(e)}


    def trigger_chat(self, pregunta: str, session_id: str) -> dict:
        request_id = str(uuid4())
